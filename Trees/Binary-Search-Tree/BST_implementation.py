import unittest
from Trees.Binary.BST_Insert_Code import BST
...
class TestBST(unittest.TestCase):
	...
	def test_remove_7(self):
		...
		self.assertEqual(4, self.bst.root.left.data)
	def test_preorder(self):# this function is explained in the BST_definitions.py file
		self.bst.insert(5)
		self.bst.insert(4)
		self.bst.insert(8)
		self.bst.insert(7)
	...
	def test_postorder(self):# this function is explained in the BST_definitions.py file
		self.bst.insert(5)
		self.bst.insert(4)
		self.bst.insert(8)
		self.bst.insert(7)
	...
	def test_inorder(self): # this function is explained in the BST_definitions.py file
		self.bst.insert(5)
		self.bst.insert(4)
		self.bst.insert(8)
		self.bst.insert(7)
